...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        id="home"
        className="bg-gradient-to-r from-emerald-50 to-green-50 py-20"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Making it easier for rural communities to access groceries,
              medicines, and daily essentials through our reliable delivery
              platform.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="#services"
                className="border-2 border-emerald-600 text-emerald-600 px-8 py-3 rounded-lg text-lg font-semibold hover:bg-emerald-50 transition-colors"
              >
                Learn More
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive solutions designed specifically for rural
              communities
            </p>
          </div>
      ...
      <section id="products" className="py-20 bg-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Essential items at affordable prices, delivered right to your
              village
            </p>
          </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-100">
                      123 Rural Development Center, Village District, State -
                      123456
                    </p>
                  </div>
                </div>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center items-center space-x-2">
              ...
              <span className="text-gray-400">
                Made with love for rural communities
              </span>
            </div>
          </div>
        </div>
